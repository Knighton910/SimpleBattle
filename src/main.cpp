...
void run()
{
    ...
    desc.w = config::screenWidth;
    desc.h = config::screenHeight;
    desc.fullscreen = config::fullscreen;
...
int main(int argc, char* argv[])
{
	run();
    printf("Count args %i \n", argc);
    config::terminalId = atoi(argv[1]);
    printf("Terminal id %i", config::terminalId);
	return 0;
}
#endif
